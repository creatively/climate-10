...
app.get('/history', function (req, res) {
    ...
    var apiUrl = encodeURI("https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/".concat(address, "/").concat(startDate, "/").concat(endDate, "?unitGroup=uk&key=ZG6RTP56DLKZJ8LWJCLVK4RM7&contentType=json"));
    (function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, axios_1["default"])(apiUrl)
                        ...
                        if (apisErrorMessage === null || apisErrorMessage === void 0 ? void 0 : apisErrorMessage.includes("Invalid location found")) {
                            console.log("--- invalid location --- ".concat(address));
                            res.status(422).send("--- invalid location --- ".concat(address));
                        }
                        else {
